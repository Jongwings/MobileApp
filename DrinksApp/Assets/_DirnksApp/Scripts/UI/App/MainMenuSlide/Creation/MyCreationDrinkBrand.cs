...
using Q.Utils;
public class MyCreationDrinkBrand : MonoBehaviour {

	public Image brandIcon;
	public Text brandName;
	[HideInInspector]
	public SeralizedClassServer.MyCreationRecipes brand;

	public void InitBrand(SeralizedClassServer.MyCreationRecipes collectionBrand)
	{
...
//			Debug.LogError ("Load Image Working Fine");
	...
	public void onclickBrand()
	{
		...
		AppManager.Instance.isRecipeDetailsForCreation = true;
