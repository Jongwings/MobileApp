...
using Q.Utils;
public class SearchPanelRecipes  : MonoBehaviour {

	public Image brandIcon;
	public Text brandName;
	[HideInInspector]
	public SeralizedClassServer.SearchPanelDrinksList brand;

	public void InitBrand(SeralizedClassServer.SearchPanelDrinksList collectionBrand)
	{
